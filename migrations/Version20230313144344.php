 ...
 */
final class Version20230313144344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, post_category_id INT NOT NULL, titre VARCHAR(150) DEFAULT NULL, message LONGTEXT DEFAULT NULL, date_publication DATETIME DEFAULT NULL, INDEX IDX_5A8A6C8DFE0617CD (post_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
